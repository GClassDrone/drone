		...
		<div class="carousel-inner">
			<div class="item active">
				...
				<div class="carousel-caption">
					<h3>Headline</h3>
					<p>We strive to be your pet's medical experts from youth
						through the senior years. We build preventative health care plans
						for each and every one of our patients, based on breed, age, and
						sex, so that your pet receives the most appropriate care at
						crucial milestones. We want to give your pet a long and healthy
						life.</p>
				</div>
			</div>
			<div class="item">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-1">
					...
					<h6 class="text-center">Young Kim</h6>
				</div>
				<div class="col-md-3">
					<div>
						<p class="text-left text-info well">Lorem ipsum dolor sit
							amet, adipiscing elit Aenean commodo ligula eget.</p>
					</div>
				</div>
				<div class="col-md-1">
					<img
						src="http://pingendo.github.io/pingendo-bootstrap/assets/user_placeholder.png"
						class="img-circle img-responsive">
					<h6 class="text-center">Matthew Kim</h6>
				</div>
				<div class="col-md-3">
