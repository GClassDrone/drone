	...
	<form>
			...
			<div class="standard-article" >
				<div class="standard-article-body--container">
									<img src="../images/drone1.jpeg" width="1200" height="490"/>
						<div class="social-byline standard-article-social-byline">
							<div class="social-byline--pub-info">
								<div class="byline ">
									...
									<!-- 회원프로필 이동  -->
										<a>
											<img class="icon img-circle" src="../images/profile.jpg" />
										</a>
									</div>
							...
							<div class="social-byline--share">
								<div class="share-module "
									data-share-location="standard-article-social-primary-btns">
										...
										<img src="../images/facebook.jpg" width="40" height="40" alt="페이스북 쉐어 버튼" title="페이스북 쉐어 버튼">
										</a>
										...
										<img src="../images/twitter.jpg" width="40" height="40" alt="트위터 쉐어 버튼" title="트위터 쉐어 버튼">
										</a>
										...
										<img src="../images/google-plus.jpg" width="40" height="40" alt="구글+ 쉐어 버튼" title="구글+ 쉐어 버튼">
										</a>
										...
										<a href="#" onclick="
										    window.open(
										      ...
										      'width=600,height=600'); 
										    return false;" title="구글+ 쉐어 버튼">
										<img src="../images/kakao.jpg" width="40" height="40" alt="구글+ 쉐어 버튼" title="구글+ 쉐어 버튼">
										</a>
										...
										<a href="#" onclick="
										    window.open(
										      ...
										      'width=600,height=600'); 
										    return false;" title="구글+ 쉐어 버튼">
										<img src="../images/band.jpg" width="40" height="40" alt="구글+ 쉐어 버튼" title="구글+ 쉐어 버튼">
										</a>
								</div>
							</div>
						</div>
				...
				<a class="prev" onclick="plusSlides(-1)">&#10094;</a>
						...
						<div class="module-story " data-uid="content.10996">
								<div class="module-story--image">
									<div class="module-story--image-inner">
										<img src="../images/drchase.jpg" width="640" height="320" />
									</div>
								</div>
					...
					<div class="mySlides fade">
						...
						<div class="module-story " data-uid="content.10996">
								<div class="module-story--image">
									<div class="module-story--image-inner">
										<img src="../images/exoticpets.jpg" width="640" height="320" />
									</div>
								</div>
								<div class="module-story--inner">
									<span class="module-story--title link-txt">
