            ...
            <div classs="col-xs-12">
                <div class="hovereffect col-xs-6 col-md-3">
		            ...
		            <div class="overlay">
		               ...
		               <a class="btn btn-warning" href="/board/sublist?bcateno=1">Go</a>
		            </div>
                </div>
                <div class="hovereffect col-xs-6 col-md-3">
		            ...
		            <div class="overlay">
		               ...
		               <a class="btn btn-warning" href="/board/sublist?bcateno=2">Go</a>
		            </div>
                </div>
                <div class="hovereffect col-xs-6 col-md-3">
		            ...
		            <div class="overlay">
		               ...
		               <a class="btn btn-warning" href="/board/sublist?bcateno=3">Go</a>
		            </div>
                </div>
                <div class="hovereffect col-xs-6 col-md-3">
                ...
                <div class="hovereffect col-xs-6 col-md-3">
		            ...
		            <div class="overlay">
		               ...
		               <a class="btn btn-warning" href="/board/sublist?bcateno=5">Go</a>
		            </div>
                </div>
				<div class="hovereffect col-xs-6 col-md-3">
		            ...
		            <div class="overlay">
		               ...
		               <a class="btn btn-warning" href="/board/sublist?bcateno=6">Go</a>
		            </div>
                </div>
                <div class="hovereffect col-xs-6 col-md-3">
		            ...
		            <div class="overlay">
		               ...
		               <a class="btn btn-warning" href="/board/sublist?bcateno=7" disabled>Go</a>
		            </div>
                </div>
                <div class="hovereffect col-xs-6 col-md-3">
